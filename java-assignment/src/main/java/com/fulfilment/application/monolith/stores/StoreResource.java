...
public class StoreResource {
  ...
  @Inject Event<StoreLegacySyncEvent> storeLegacySyncEvents;
  ...
  public Response create(Store store) {
    ...
    storeLegacySyncEvents.fire(
        new StoreLegacySyncEvent(
            StoreLegacySyncEvent.Kind.CREATE,
            store.id,
            store.name,
  ...
  public Store update(Long id, Store updatedStore) {
    ...
    storeLegacySyncEvents.fire(
        new StoreLegacySyncEvent(
            StoreLegacySyncEvent.Kind.UPDATE,
            entity.id,
            entity.name,
